...
Я изучил структуру http-запроса и понял из разных функциональных частей, таких, как: протокол, хост, порт, путь к ресурсу, строки с аргументами и якоря.

#I. Подготовка к работе с сервисом openweathermap.org 
Чтобы получить API Key(представляет из себя шестнадцатеричный код) я зарегистрировался на сайте http://openweathermap.org/. После регистрации в разделе API Keys Я получил следующий ключ: b412de423d3145ef2e2941fa464b6aa1.
