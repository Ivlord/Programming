...
<h2>Цель работы</h2>
<p style="margin-left: 50px;">Разработать сервис предоставляющий данные о погоде в городе Симферополе на момент запроса.<br>  В качестве источника данных о погоде используйте: http://openweathermap.org/. В состав сервиса входит: серверное приложение на языке С++ и клиентское приложение на языке Python.</p>
...
<pre>    Для начала работы с сервисом необходимо пройти регистрацию и получить уникальный API Key.<br>
Чтобы его получить я зарегистрировался на сайте http://openweathermap.org/ и в разделе API Keys получил следующий ключ: <b>b412de423d3145ef2e2941fa464b6aa1.</b><br></pre>
