...
<br>&nbsp;&nbsp;&nbsp;&nbsp;Приложение на пайтоне читает отчёт и выводит его в графическом виде.
...
3. <b>Только, если закоментирован пункт 2.</b> Можно настроить стартовый размер вектора и его стартовую .capacity().
...
- Если много цифр то это изменение ёмкости по рядам сверху вниз и значений ёмкости справа налево соответственно.<br>
...
По мере возрастания вектора с++ должен обеспечить непрерывность элементов в памяти и вынужден искать всё большие непрерывные участки памяти.<br><br>
...
Изменение начальной ёмкости меняет ряд изменения ёмкостей. Но правило остаётся то же: следующий размер выделяемой памяти будет в полтора раза больше, чем текущая ёмкость.<br>
