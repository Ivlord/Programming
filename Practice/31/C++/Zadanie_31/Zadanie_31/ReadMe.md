...
Ккаждый раз, когда встаёт необходимость увеличить вектор, а памяти уже не хватает, то с++, новый блок 
...
Я не увидел никакой разницы при передаче вектора по ссылке и по значению. Думаю, что при уменьшении вектора переданного 
